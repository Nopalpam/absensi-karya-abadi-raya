...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class="box-tools">
            <button onclick="addForm(`{{ route('area.store') }}`)" class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah</button>
        </div>
    </div>
    <div class="box-body">
...
<script>
    ...
    function addForm(url) {
        ...
        $('#modal-form .modal-title').text('Tambah Area');
    ...
    function editForm(url) {
        $('#modal-form').modal('show');
        $('#modal-form .modal-title').text('Edit Area');
        $('#modal-form form').attr('action', url);
