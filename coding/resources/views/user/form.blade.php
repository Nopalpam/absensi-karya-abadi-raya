            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="level" class="col-lg-3 col-lg-offset-1 control-label">Status Pengguna</label>
                        <div class="col-lg-6">
                            <select name="level" id="level" class="form-control" required>
                                <option value="karyawan" selected>Karyawan</option>
                                <option value="admin">Admin</option>
                                <option value="admininvoice">Admin Invoice</option>
                            </select>
                    ...
                    <div class="form-group row">
                        <label for="nip" class="col-lg-3 col-lg-offset-1 control-label">No. NIP</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row edituser">
